...
local neovide_config = function()
  ...
  vim.g.neovide_background_color = '#1d1f21' .. string.format('%x', math.floor(255 * global.transparency))
  ...
  vim.g.gui_font_size = global.gui_font_default_size
  vim.g.gui_font_face = "UDEV Gothic 35NFLG"
end
